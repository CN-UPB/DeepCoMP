...
do
  ...
  deepcomp --seed 42 --workers $num_workers --eps-length 30 --train-steps 100000 --batch-size 1000 --alg ppo --agent $agent --env small --slow-ues $num_ues --sharing proportional-fair --eval 50
done
