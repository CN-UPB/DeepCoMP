...
do
  ...
  deepcomp --workers $num_workers --eps-length 100 --train-iter 200 --batch-size 4000 --alg ppo --agent $agent --env medium --slow-ues $num_ues --sharing proportional-fair --eval 50
done
