...
def create_env_config(agent, map_size, num_slow_ues, num_fast_ues, eps_length, num_workers=1, train_batch_size=1000,
                      seed=None, agents_share_nn=True):
    """
    ...
    map, ue_list, bs_list = get_env(map_size, num_slow_ues, num_fast_ues)
